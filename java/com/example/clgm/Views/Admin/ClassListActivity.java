...
import com.example.clgm.Adapter.DepartmentListAdapter;
...
public class ClassListActivity extends AppCompatActivity {
        ...
        saveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(departmentName.isEmpty()){
                    ...
                    updateDepartment(departmentName,department.getClassId(),dialog);
                }
            }
        });
    }
    ...
    private void updateDepartment(String departmentName,String departmentId, AlertDialog dialog) {
        ...
        updateMap.put("className",departmentName);
        ApiRef.classRef.child(departmentId)
